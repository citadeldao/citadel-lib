...
/**
 * Generates a wallet object (with address, publicKey etc) via the Trzor device
 *
 ...
 * @example
 *
 * const response = await citadel.createWalletByTrezor({
 *   net: 'btc',
...
export const createWalletByTrezor = async (options) => {
  // checks
  checkInitialization()
